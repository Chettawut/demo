...
<head>
    ...
    <title>รับชำระหนี้ (Receive Payment) </title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0"><i class="fa fa-cart-plus"></i> รับชำระหนี้ (Receive Payment)</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="<?php echo PATH; ?>/accounting">Accounting</a></li>
